...
export default function AIPanel() {
  ...
  return (
    ...
    >
      <div className="relative z-10 mx-auto w-full max-w-[1280px] px-6 py-32 sm:px-8 md:py-40 lg:px-12 lg:py-48">
  ...
  return (
    <div className="aipanel-browser">
      <div className="aipanel-browser-chrome">
        ...
        <div className="aipanel-browser-url">saldox.app</div>
